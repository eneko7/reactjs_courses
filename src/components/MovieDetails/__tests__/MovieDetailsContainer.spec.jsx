...
import MovieDetailsContainer from '../index';
...
jest.mock('../MovieDetails', () => jest.fn().mockReturnValue(null));

describe('MovieDetails', () => {
  it('MovieDetailsContainer.spec ', () => {
    TestRenderer.create(
    ...
    expect(MovieDetailsContainer).toBeCalledTimes(1);
  });
});
